...
const uintptr_t __irq_vector_table _irq_vector_table[75] = {
...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[75] = {
	...
	{(const void *)0x10005fc8, (ISR)0x1000565d}, /* 61 */
	{(const void *)0x0, (ISR)z_irq_spurious}, /* 62 */
	{(const void *)0x10005fa8, (ISR)0x1000565d}, /* 63 */
