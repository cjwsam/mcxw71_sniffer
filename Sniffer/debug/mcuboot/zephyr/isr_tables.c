...
uintptr_t __irq_vector_table _irq_vector_table[75] = {
...
struct _isr_table_entry __sw_isr_table _sw_isr_table[75] = {
	...
	{(const void *)0x10008354, (ISR)0x10002b85}, /* 43 */
	...
	{(const void *)0x1000832c, (ISR)0x10006505}, /* 63 */
